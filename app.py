...
# context processor to make datatime available in all templates
...
if not app.config['SQLALCHEMY_DATABASE_URI']:
    raise EnvironmentError("DATABASE_URL environment variable is not set! Check your .env or deployment settings.")
...
if not app.config['SECRET_KEY']:
    raise EnvironmentError("FLASK_SECRET_KEY environment variable is not set! Check your .env or deployment settings.")
